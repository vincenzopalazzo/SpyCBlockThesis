...
\lstinputlisting[language=Python, label=code:decodeTransaction, caption=Porzione di codice estrapolato da \cite{parser:blocktools} che riporta il metodo di deserializzazione della transazione dopo l'aggiornamto al Segregated Witness.]{code/decodeTransaction.py}
...
\lstinputlisting[language=C++, label=code:processBuilHashTx, caption=Processo di creazione dell'hash della transazione estratto dai test di unità di SpayCBlock.]{code/serializationTestWithShaTx.cpp}
